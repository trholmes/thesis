...
\part{The Physical Experiment} % Second part of the thesis

\include{Chapters/Chapter03} % LHC
\include{Chapters/Chapter04} % ATLAS
\include{Chapters/Chapter05} % Tracking
...
\part{Searching for SUSY} % Second part of the thesis
\label{part:search}

%\include{Chapters/Chapter04} % Chapter 2
