...
The $k$ factors are defined by a square root because, when using dilepton events, the quantity being measured is the efficiency of the detection of two leptons. Assuming that the two leptons have similar efficiencies, the square root of this quantity gives the efficiency for a single lepton. 
...
In these 1-jet \acp{CR}, events are first binned in boson \pt, and in each bin, an \metl distribution is made. The smearing function is defined for each bin as the deconvolution of the \dyjets and \gjets \metl distributions.
...
\includegraphics[width=.48\linewidth]{figures/photons/MC_hist_met_plot_ee_2j_2016_mcmetl_ptrw__zmet_.pdf}
\includegraphics[width=.48\linewidth]{figures/photons/MC_hist_met_plot_ee_2j_2016_mcmetl_ptsmrw_smear_zmet_.pdf}
...
\includegraphics[width=.48\linewidth]{figures/photons/MC_hist_met_plot_mm_2j_2016_mcmetl_ptrw__zmet_.pdf}
\includegraphics[width=.48\linewidth]{figures/photons/MC_hist_met_plot_mm_2j_2016_mcmetl_ptsmrw_smear_zmet_.pdf}
...
\resizebox{1\textwidth}{!}{
 \begin{tabular}{lccccccc} %{\textwidth}{@{\extracolsep{\fill}}lcccccccc}
   ...
   \noalign{\smallskip}\hline\hline\noalign{\smallskip}
   CR-real          &  $-$      &  $> 200$  &  $\geq 2$ &  81--101    &  $2\ell$ SF  & OS & $2$\\
   CR-fake          &  $<125$   &  $-$      &  $-$ & $>12$     &   $2\ell$ SF/DF  &  SS & $\geq2$\\
   \noalign{\smallskip}\hline\noalign{\smallskip}
   \noalign{\smallskip}\hline\noalign{\smallskip}
\end{tabular}
} % end of resizebox
...
\begin{figure}[!htb]
\centering
\includegraphics[width=.48\textwidth]{figures/fakes/ee-CutSSMET_zveto-Mll-lin.pdf}
\includegraphics[width=.48\textwidth]{figures/fakes/mm-CutSSMET_zveto-Mll-lin.pdf}
\includegraphics[width=.48\textwidth]{figures/fakes/em-CutSSMET_zveto-Mll-lin.pdf}
\includegraphics[width=.48\textwidth]{figures/fakes/me-CutSSMET_zveto-Mll-lin.pdf}
