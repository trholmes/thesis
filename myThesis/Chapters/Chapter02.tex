...
\begin{equation}
\begin{split}
\mathcal{L}_{fermion} = & -\frac{1}{2}\bar{L}_m\fsl{D}L_m -\frac{1}{2}\bar{Q}_m\fsl{D}Q_m \\
						& -\frac{1}{2}\bar{U}_m\fsl{D}U_m -\frac{1}{2}\bar{D}_m\fsl{D}D_m \\
						& -\frac{1}{2}\bar{E}_m\fsl{D}E_m \\
\end{split}
\end{equation}
